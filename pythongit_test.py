...
class Anotherwindow(QWidget):
    def __init__(self,ser_fru,ser_gra,ser_dar,ser_pro,ser_veg):
        super().__init__()
        layout = QVBoxLayout()
        self.label = QLabel("The fruit serving " + ser_fru)
        layout.add_widget(self.label)
        self.2label = QLabel("The grain serving " + ser_gra)
        layout.add_widget(self.2label)
        self.label = QLabel("The dariy serving " + ser_dar)
        layout.add_widget(self.label)
        self.label = QLabel("The protein serving " + ser_pro)
        layout.add_widget(self.label)
